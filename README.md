...
```shell
kubectl create secret generic rapidast-storage-access-key --from-file=your-service-account_key.json=/local/path/to/your-service-account_key.json -n ${PIPELINE_NAMESPACE}
```
